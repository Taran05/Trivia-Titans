...
import { getUserByEmail, getUserStatisticsByEmail } from '../../apis/ProfileAPI';
        ...
        if (userId != null) {
            getUserByEmail(userId).then((res) => {
                if (res.status === 200) {
                    ...
                    // Fetch user statistics based on the email
                    getUserStatisticsByEmail(res.data.email).then((res) => {
                        if (res.status === 200) {
